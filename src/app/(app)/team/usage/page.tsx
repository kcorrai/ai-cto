...
import { UsageReport } from "@/components/team/UsageReport";
...
export default async function UsagePage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-lg font-semibold text-[#f0f0f0]">Usage Reporting</h1>
        <p className="mt-1 text-sm text-[#606060]">
          Analysis usage, seat breakdown, and per-user activity.
        </p>
      </div>
      <UsageReport />
    </div>
